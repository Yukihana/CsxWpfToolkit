...
public partial class DefaultLightThemeProvider
{
    private readonly Dictionary<ThemeSlots, Color> _colors = new()
    {
        // Control Background
        { ThemeSlots.ControlBackgroundNormal, ColorValues.HexDD.AsColor() },
        ...
        // Control Border
        { ThemeSlots.ControlBorderNormal, ColorValues.Hex88.AsColor() },
        ...
        // Control Foreground
        { ThemeSlots.ControlForegroundNormal, ColorValues.Hex44.AsColor() },
        ...
        // Control Text
        { ThemeSlots.ControlTextNormal, ColorValues.Hex44.AsColor() },
